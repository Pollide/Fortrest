...
public class GrassComputeScript : MonoBehaviour
{
    ...
    public static GrassComputeScript global;
    ...
    public List<ShaderInteractor> interactors = new();
    ...
    {
        ShaderInteractor[] statsObjects = FindObjectsOfType<ShaderInteractor>();
        foreach (ShaderInteractor s in statsObjects)
        {
            interactors.Add(s);
        }
    ...
    private void SetGrassDataUpdate()
    {
        ...
        {
            Vector4[] positions = new Vector4[interactors.Count];
            ...
            m_InstantiatedComputeShader.SetFloat("_InteractorsLength", interactors.Count);
        }
        // else
        // {
